      ...
      <div class='container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
        <div class='w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left'>
          ...
          >
            ...
            <span class='ml-3 text-xl'>Tú và Bảo</span>
          </NavLink>
        ...
        <div class='flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center justify-end'>
          ...
          <div class='lg:w-1/4 md:w-1/2 w-full px-4'>
            ...
            <nav class='list-none mb-10'>
              <li>
                <a class='text-gray-600 hover:text-gray-800'>Mũ</a>
              </li>
              <li>
                <a class='text-gray-600 hover:text-gray-800'>Áo Thun</a>
              </li>
              <li>
          ...
          <div class='lg:w-1/4 md:w-1/2 w-full px-4'>
            ...
            <nav class='list-none mb-10'>
              ...
              <li>
                <a class='text-gray-600 hover:text-gray-800'>Quyền bảo mật</a>
              </li>
              <li>
